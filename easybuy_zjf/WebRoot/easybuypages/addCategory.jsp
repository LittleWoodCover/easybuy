...
<!--[if IE 6]>
    ...
    <![endif]-->
<script type="text/javascript"
	src="${path}/js/jquery-1.11.1.min_044d0927.js"></script>
...
<script type="text/javascript" src="${path}/js/addCategory.js" charset="utf-8"></script>
<title>管理中心</title>
</head>
<body>
		...
		<div class="sou">
			...
			<span class="fr"> <span class="fl">你好，请<a
				...
				class="fr">|&nbsp;<a href="#">手机版&nbsp;<img
						src="${path}/images/s_tel.png" align="absmiddle" /></a></span>
			</span>
		</div>
	</div>
	<div class="m_top_bg">
		<div class="top">
			<div class="m_logo">
				<a href="Index.html"><img src="${path}/images/logo1.png" /></a>
			</div>
			<div class="m_search">
				<form>
			...
			<div class="i_car">
				...
				<div class="car_bg">
					...
					<ul class="cars">
						<li>
							<div class="img">
								<a href="#"><img src="${path}/images/car1.jpg" width="58"
									height="58" /></a>
							</div>
							<div class="name">
						...
						<li>
							<div class="img">
								<a href="#"><img src="${path}/images/car2.jpg" width="58"
									height="58" /></a>
							</div>
							<div class="name">
	...
	<div class="i_bg bg_color">
			...
			<div class="m_left">
				...
				<div class="left_m">
					...
					<ul>
						...
						<li><a href="${path}/easybuypages/admin.jsp">用户列表</a></li>
				...
				<div class="left_m">
					...
					<ul>
						<li><a href="${path}/easybuypages/fenleiadmin.jsp">分类管理</a></li>
						<li><a href="${path}/easybuypages/productadmin.jsp">商品管理</a></li>
					</ul>
				</div>
				<div class="left_m">
					<div class="left_m_t t_bg4">资讯列表</div>
					<ul>
						<li><a href="${path}/easybuypages/Member_ZXL.jsp">资讯列表</a></li>
					</ul>
				</div>
			</div>
			<div class="m_right" id="m_m">
				<p></p>

				<div class="mem_tit">添加分类</div>
				<form action="${path}/categoryServlet?opr=addcategory" method="post">
					<table>
						<tr>
							<td>分类级别</td>
							<td><select onchange="fenleichoose(this)" name="type">
						...
						<tr style="display: none" >
							<td>一级分类</td>
							<td><select onchange="onefenleichoose(this)" id="categoryone" name="categoryone">
									<option selected="selected">请选择</option>
						...
						<tr style="display: none" >
							<td>二级分类</td>
							<td><select id="categorytwo" name="categorytwo">
									<option selected="selected">请选择</option>
							</select></td>
						</tr >
						<tr>
		...
		<div class="b_btm_bg b_btm_c">
			<div class="b_btm">
				<table border="0"
					...
					<tr>
						<td width="72"><img src="${path}/images/b1.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${path}/images/b2.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${path}/images/b3.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					cellspacing="0" cellpadding="0">
					<tr>
						<td width="72"><img src="${path}/images/b4.png" width="62"
							height="62" /></td>
		...
		<div class="b_nav">
			...
			<div class="b_er">
				<div class="b_er_c">
					<img src="${path}/images/er.gif" width="118" height="118" />
				</div>
		...
		<div class="btmbg">
			<div class="btm">
				...
				<img src="${path}/images/b_1.gif" width="98" height="33" /><img
					src="${path}/images/b_2.gif" width="98" height="33" /><img
					src="${path}/images/b_3.gif" width="98" height="33" /><img
					src="${path}/images/b_4.gif" width="98" height="33" /><img
					src="${path}/images/b_5.gif" width="98" height="33" /><img
					src="${path}/images/b_6.gif" width="98" height="33" />
			</div>
		</div>
		<!--End Footer End -->
	</div>
