...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script type="text/javascript" src="${path}/js/userList.js" charset="utf-8"></script>
	...
	<div class="m_content">
		...
		<div class="m_right" id="m_m">
            ...
            <table border="0" class="mem_tab" style="width:930px; margin-bottom:30px;" cellspacing="0" cellpadding="0">
                        <tr><td>用户名称</td><td>真实姓名</td><td>性别</td><td>类型</td><td><a href="">修改</a></td><td><a href="">删除</a></tr> 
			</table>
			<div id="m_right"></div>
