                ...
                <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                 ...
                 <tr height="45">
                  ...
                  <tr height="45">
                    ...
                    <td><input id="name"type="text" value="${param.email }" class="add_ipt" style="width:180px;" name="email" required/>&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="45">
                  ...
                  <tr height="45">
                    ...
                    <td><textarea rows="3" cols="30"></textarea>&nbsp; <font color="#ff4e00">*</font></td>
                  </tr>                 
                  <tr height="50">
                    <td>&nbsp;</td>
